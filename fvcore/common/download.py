...
def download(
    ...
    """
    Download a file from a given URL to a directory.
    If file exists, will not overwrite the existing file.
    ...
    try:
        ...
        # download to tmp first and move to fpath, to make this function more atomic
