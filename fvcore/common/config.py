...
class CfgNode(_CfgNode):
    ...
    def load_yaml_with_base(filename: str, allow_unsafe: bool = False):
        ...
        with open(filename, "r") as f:
            try:
                ...
                logger.warning(
                    "Loading config {} with yaml.unsafe_load. Your machine may be at "
                    "risk if the file contains malicious content.".format(
                        filename
                    )
                )
                f.close()
    ...
    def merge_from_file(self, cfg_filename: str, allow_unsafe=False):
        """
        Args:
